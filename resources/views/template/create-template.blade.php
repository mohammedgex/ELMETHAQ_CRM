...
@section('content')
    <div class="card shadow-lg p-4 border-0 animate__animated animate__fadeIn" style="border-radius: 15px;">
        <h4 class="mb-3 text-success font-weight-bold" style="color: #997a44 !important;">إضافة قالب جديد</h4>
        <form action="{{ route('template.create') }}" method="POST">
            ...
            <button type="submit" class="btn mt-3 px-4 shadow-sm w-100"
                style="background-color: #28a745; color: white;">إضافة القالب </button>
        </form>
        ...
        <div class="col-md-12">
            <div class="card shadow-lg p-4 border-0 animate__animated animate__fadeIn"
                ...
                <h4 class="mb-3" style="color: #343a40; font-weight: bold;">
                    قائمة القوالب <span class="text-success">({{ $templates->count() }})</span>
                </h4>
