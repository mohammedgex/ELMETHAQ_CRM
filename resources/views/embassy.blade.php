    ...
    <div class="row">
                    ...
                    <form action="{{ route('embassy.create') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-12 form-group">
                                ...
                                <select class="form-control fw-bold" style="border-color: #343a40;" name="title" required>
                        ...
                        <div class="row">
                            <div class="col-md-12 form-group">
                                ...
                                <select class="form-control fw-bold" style="border-color: #343a40;" name="title" required>
                                    <option value="">اختر القنصلية</option>
                                    <option value="السويس"
                                        {{ old('title', $embassyEdit->title ?? '') == 'السويس' ? 'selected' : '' }}>
                                        قنصلية السويس</option>
                                    <option value="القاهرة"
                                        {{ old('title', $embassyEdit->title ?? '') == 'القاهرة' ? 'selected' : '' }}>
                                        قنصلية القاهرة</option>
                                    <option value="الاسكندرية"
                                        {{ old('title', $embassyEdit->title ?? '') == 'الاسكندرية' ? 'selected' : '' }}>
        ...
        <div class="col-md-12">
            <div class="card shadow-lg p-4 border-0 animate__animated animate__fadeIn"
                ...
                <h4 class="mb-3" style="color: #343a40; font-weight: bold;">قائمة القنصلية</h4>
