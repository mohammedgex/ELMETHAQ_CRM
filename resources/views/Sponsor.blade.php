    ...
    <div class="row">
                ...
                <form action="" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-4 form-group">
                            ...
                            <input type="text" class="form-control" name="name" placeholder="أدخل اسم الكفيل" required>
                        </div>
                        <div class="col-md-4 form-group">
        ...
        <div class="col-md-12">
            <div class="card shadow-lg p-4 border-0 animate__animated animate__fadeIn" style="border-radius: 15px; background-color: #eae0d5;">
                <h4 class="mb-3 text-dark font-weight-bold">قائمة الكفلاء</h4>
                    ...
                    <table class="table table-hover text-center animate__animated animate__fadeInUp" id="delegatesTable">
                        ...
                        <tbody>
                            <tr class="table-light">
                                <td>#</td>
                                <td class="highlight">مجموعة مؤقتة 6 شهور</td>
                                <td class="highlight">مجموعة مؤقتة 6 شهور</td>
                                <td class="highlight">مجموعة مؤقتة 6 شهور</td>
                                <td>
