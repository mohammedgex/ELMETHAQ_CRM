    ...
    <div class="row">
                ...
                <div class="card shadow-lg p-4 border-0 animate__animated animate__fadeIn"
                    ...
                    <form action="{{ route('visa-profession.create', $visa_id) }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                <label class="font-weight-bold" style="color: #343a40;"> العدد لهذه المهنة </label>
                                <input type="text" class="form-control" style="border-color: #343a40;"
                                    name="profession_count" placeholder="أدخل العدد" required>
                            </div>
                        </div>
                        <!-- زر بعرض كامل -->
        ...
        <div class="col-md-12">
            <div class="card shadow-lg p-4 border-0 animate__animated animate__fadeIn"
                ...
                <h4 class="mb-3" style="color: #343a40; font-weight: bold;">قائمة المهن</h4>
