...
<h4 class="mt-4 mb-3" style="font-weight:bold"> المجموعات</h4>

@php
    $groups = [
        ['name' => 'مجموعة مكة', 'icon' => 'fas fa-mosque', 'class' => 'group-makkah'],
        ['name' => 'مجموعة المدينة', 'icon' => 'fas fa-kaaba', 'class' => 'group-madina'],
        ['name' => 'مجموعة الرياض', 'icon' => 'fas fa-city', 'class' => 'group-riyadh'],
        ['name' => 'مجموعة الدمام', 'icon' => 'fas fa-water', 'class' => 'group-dammam'],
        ['name' => 'مجموعة جدة', 'icon' => 'fas fa-umbrella-beach', 'class' => 'group-jeddah'],
    ];
@endphp
...
<div class="row justify-content-center">
    @foreach ($groups as $group)
        <div class="col-auto mb-3">
            <div class="group-circle {{ $group['class'] }}">
...
<div class="row justify-content-center">
    <div class="col-lg-3 col-md-6 col-sm-12 mb-3">
        <div class="info-card small-card">
            ...
            <div class="info-content">
                <div class="info-title">  العملاء المضافين</div>
                <div class="info-number">1,410</div>
            </div>
        </div>
    </div>
