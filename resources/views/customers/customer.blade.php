                        ...
                        <div class="mb-3 me-2 mx-2">
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <button class="dropdown-item text-primary" data-bs-toggle="modal" data-bs-target="#whatsappModal">إرسال
                                            رسالة نصية</button>
                                    </li>
                                    <li>
                ...
                <div class="modal-body">
                    <form id="assignGroupForm">
                        ...
                        <div class="d-flex justify-content-end mt-4">
                            <button type="button" class="btn btn-outline-secondary me-2" data-bs-dismiss="modal" style="border-radius: var(--border-radius); padding: 0.65rem 1.5rem;">
                                إلغاء
                            </button>
