        ...
        <div class="card-body">
            ...
            <div class="tab-content mt-3">
                        ...
                        @foreach ($histories as $history)
                            <li class="timeline-item">
                                ...
                                <div class="timeline-content">
                                    ...
                                    <h3 class="bold mt-4">{{ $history->description }}</h3>
                                </div>
                            </li>
                        @endforeach
                    </ul>
                ...
                <div class="modal fade" id="stepModal" tabindex="-1" aria-labelledby="stepModalLabel" aria-hidden="true">
                    <form action="{{ route('customer.history', '6') }}" method="POST" class="modal-dialog">
                        @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control fw-bold"
                                        ...
                                        placeholder="أدخل الاسم الكامل" name="name_ar">
                                </div>
                                <div class="col-md-6">
                                    <label class="fw-bold" style="color: #997a44;">الرقم القومي</label>
                                    <input type="text" class="form-control fw-bold"
                                        style="height: 60px; border-color: #997a44;" value="{{ $edit->card_id }}"
                                        placeholder="أدخل الرقم القومي" name="card_id">
                                </div>
