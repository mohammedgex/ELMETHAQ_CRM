                ...
                <form action="{{ route('customer.mrz', $edit->id) }}" method="POST" class="table-wrapper"
                    ...
                    <div class="d-flex align-items-start gap-4">
                        ...
                        <div class="form-group" style="width: 50%; margin: auto;">
                            <label class="fw-bold d-block mb-2" style="color: #997a44;" for="passport_image">صورة الجواز</label>

                            <div style="
        width: 100%;
        height: 150px;
        position: relative;
        border: 2px dashed #997a44;
        border-radius: 8px;
        overflow: hidden;
        background-color: #fdf8f1;">

                                <input type="file" id="passportInput" name="mrz_image"
                            ...
                            <div style="margin-top: 15px; display: flex; align-items: center; gap: 15px;">
                                ...
                                <div id="gggg" class="loader" style="display: none; border: 4px solid #f3f3f3; border-top: 4px solid #997a44; border-radius: 50%; width: 24px; height: 24px; animation: spin 1s linear infinite;"></div>

                                <div id="hhhh" class="loading-text" style="display: none; font-size: 14px; color: #997a44;">
                                    الرجاء الانتظار...
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group rounded">
                                <input type="text" class="form-control fw-bold"
                                    style="height: 60px; border-color: #997a44;" id="issue_place" name="issue_place"
